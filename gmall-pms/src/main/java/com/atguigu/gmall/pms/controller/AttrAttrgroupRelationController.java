...
public class AttrAttrgroupRelationController {
    ...
    public Resp<Object> deleteRelationByGid(@RequestBody List<AttrAttrgroupRelationEntity> relationEntities){
        this.attrAttrgroupRelationService.deleteRelationByGid(relationEntities);
        return Resp.ok("删除成功");
    }
    /**
     * 列表
